var showMe = document.querySelector("#show-event");
 ...
 * been invoked, any functions passed to whenReady() will be invoked immediately.
 */
...
var whenReady = (function() { // This function returns the whenReady() function
	...
	function handler(e) {
		...
		// something other than "complete", then return.
		if (e.type === "readystatechange" && document.readyState !== "complete") return;

		// Run all registered functions
		// Note that we look up funcs.length each ti,e, in case calling
